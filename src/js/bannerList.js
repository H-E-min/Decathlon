...
function bannerListFn(a,b,c,d,e,f){
    ...
    function imgListBtn (){
        ...
        $imgBtnList.children().click(function(){
            ...
            array=index;
            bannerImgList(index);
            $imgBtnList.children().eq(array).addClass("current load-bar").siblings().removeClass("current load-bar");
    ...
    function move(){
        ...
        (array == liLength-1) ? $imgBtnList.children().eq(0).addClass("current load-bar").siblings().removeClass("current load-bar") : $imgBtnList.children().eq(array).addClass("current load-bar").siblings().removeClass("current load-bar");
